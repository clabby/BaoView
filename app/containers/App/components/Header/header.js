...
import { HeaderBar, HeaderLogo, CommunityToolsHeader } from './styles/styled';
          ...
          <Nav className="mr-auto">
            ...
            <NavDropdown title="Help" id="help-dd">
              <NavDropdown.Item href="https://docs.bao.finance/faq/bao-related-questions">
                <FontAwesomeIcon icon={['fa', 'question-circle']} /> Bao Related{' '}
                Questions
              </NavDropdown.Item>
              <NavDropdown.Item href="https://docs.bao.finance/faq/technical-questions">
                <FontAwesomeIcon icon={['fa', 'question-circle']} /> Technical{' '}
                Questions
              </NavDropdown.Item>
              <NavDropdown.Item href="https://docs.bao.finance/faq/defi-questions">
                <FontAwesomeIcon icon={['fa', 'question-circle']} /> DeFi{' '}
                Questions
              </NavDropdown.Item>
            ...
            <NavDropdown title="Resources" id="resources-dd">
              ...
              <NavDropdown.Item href="https://discord.gg/vuYHdgyryg">
                <FontAwesomeIcon icon={['fab', 'discord']} /> Bao Finance{' '}
                Discord
              </NavDropdown.Item>
              <NavDropdown.Divider />
